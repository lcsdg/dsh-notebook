	...
	factory: (require) => {
		...
		*/
		function observeSelection(onChange) {
			...
			let down = null;
			const onMouseDown = (e) => {
				down = (e.target instanceof Element ? e.target.closest("[data-notebook-ui]") : null) !== null ? null : {
					x: e.clientX,
					y: e.clientY
				};
			};
		...
		*/
		function NotebookButton(props) {
			...
			const [popupText, setPopupText] = (0, react.useState)("");
			...
			(0, react.useEffect)(() => observeSelection((sel) => {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [
				...
				popupOpen ? (0, react_dom.createPortal)(/* @__PURE__ */ (0, react_jsx_runtime.jsx)(AddToNotebookPopup, {
					store,
					text: popupText,
					t,
					onClose: finishAdd,
