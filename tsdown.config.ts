/**
 * Standalone build config for the dsh-notebook plugin.
 *
 * Reuses the bundled client-bundle preset (shared/tsdown.client.ts — closure-
...
export default clientBundle('@max1997/dsh-notebook', ['src/index.ts'], {
  libExternal: [
